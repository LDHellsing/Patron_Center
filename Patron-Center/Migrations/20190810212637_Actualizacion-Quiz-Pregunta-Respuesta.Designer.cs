...
namespace Patron_Center.Migrations
{
    ...
    [Migration("20190810212637_Actualizacion-Quiz-Pregunta-Respuesta")]
    partial class ActualizacionQuizPreguntaRespuesta
    {
            ...
            modelBuilder.Entity("Patron_Center.Models.Curso", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DocenteId = 2,
                            Eliminado = false,
                            FechaFinalizacion = new DateTime(2019, 8, 10, 18, 26, 36, 799, DateTimeKind.Local).AddTicks(1577),
